...
d_adaptive = Derivatives(filter_cmd = True, target_accel_type = target_accel_type, target_accel = target_accel, target_accel_amp = target_accel_amp, accel_sat = 3.)
# d_png = Derivatives(filter_cmd = False, target_accel_type = 'constant', target_accel = -25, target_accel_amp = -10, accel_sat = np.inf)
# d_aftng = Derivatives(filter_cmd = False, target_accel_type = 'constant', target_accel = -25, accel_sat = np.inf)
# d_ftcg = Derivatives(filter_cmd = False, target_accel_type = 'constant', target_accel = -25, accel_sat = np.inf)
...
x0_png = np.concatenate((seeker0_PNG, target0))
x0_ftcg = np.concatenate((seeker0_FTCG, target0))
x0_aftng = np.concatenate((seeker0_AFTNG, target0))
...
s_aftng_collision_idx, s_aftng_miss_dist = p.plot_S_AFTNG_data(S_AFTNG_solution, d_adaptive, collision_buffer_range, target_accel_type, target_accel, target_accel_amp)

seekers = {"S-AFTNG": {"t_array": S_AFTNG_solution.t[:(s_aftng_collision_idx + 1)],
                       "hist": S_AFTNG_solution.y[:4, :(s_aftng_collision_idx + 1)],
                       "LOS_lines": False,
                       "LOS_period": 4}
        ...
        #    },
        #    "AFTNG": {
        #         "t_array": AFTNG_solution.t[:150],
        #         "hist": AFTNG_solution.y[:4, :150],
        #         "LOS_lines": False,
        #         "line_color": "orange",
        #         "LOS_period": 8
        #       },
        #    "FTCG": {
        #         "t_array": FTCG_solution.t,
        #         "hist": FTCG_solution.y[:4],
        #         "LOS_lines": False,
        #         "line_color": "purple",
        #         "LOS_period": 8
        #    }
...
p.plot_trajectories(seekers, S_AFTNG_solution.y[5:9, :(s_aftng_collision_idx + 1)])
